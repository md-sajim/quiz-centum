      ...
      <div className='piechart-container'>
        <div className='pieChart'>
          <ResponsiveContainer  height={250}>
            <PieChart>
              <Pie data={data3} dataKey="total" nameKey="name" cx="50%" cy="50%" innerRadius={60} outerRadius={90} fill="#82ca9d" label />
              <Tooltip />
            </PieChart>
          </ResponsiveContainer>
        </div>
        <div className='pieChart'>
          <ResponsiveContainer    height={250}>
            <PieChart>
              <Pie data={data3} dataKey="total" nameKey="name" cx="50%" cy="50%" outerRadius={90} fill="#8884d8" label />
              <Tooltip />
            </PieChart>
          </ResponsiveContainer>
        </div>
